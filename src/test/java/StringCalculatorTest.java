...
public class StringCalculatorTest {
  ...
  public void testPlusGrandMille() {
    ...
    assertEquals(50, Calculator.add("1001,50"));
  }
  ...
  public void testNegatif() {
    try {
      ...
      assertEquals(e.getMessage(), "Les n�gatifs ne sont pas accept�s: -1");
    }

    try {
      Calculator.add("2,-4,3,-5");
    } catch (IllegalArgumentException e) {
      assertEquals(e.getMessage(), "Les n�gatifs ne sont pas accept�s: -4,-5");
    }
  }
